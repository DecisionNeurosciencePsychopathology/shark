...
parameters {
  ...
  real<lower=0> beta_m;
  real<lower=0> beta_s;
  real<lower=0> beta_mod_m;
  real<lower=0> beta_mod_s;
...
transformed parameters {
  ...
  beta_u_normal = beta_m + (beta_s * beta_raw);
  beta_mod = beta_mod_m + (beta_mod_s * beta_mod_raw);
  beta_1_MF_normal = beta_u_normal;
  beta_1_MB_normal = beta_u_normal + beta_mod;
