...
transformed parameters {
  ...
  //Shark Paras
  alpha_normal_shark = alpha_m_shark + (alpha_s*alpha_raw) + (grp_dep*alpha_m_diff_dep) + (grp_ide*alpha_m_diff_ide) + (grp_att*alpha_m_diff_att);
  alpha_shark = inv_logit(alpha_normal_shark);
  beta_1_MF_shark = beta_1_MF_m_shark + (beta_1_MF_s*beta_1_MF_raw) + (grp_dep*beta_1_MF_m_diff_dep) + (grp_ide*beta_1_MF_m_diff_ide) + (grp_att*beta_1_MF_m_diff_att);
  beta_1_MB_shark = beta_1_MB_m_shark + (beta_1_MB_s*beta_1_MB_raw) + (grp_dep*beta_1_MB_m_diff_dep) + (grp_ide*beta_1_MB_m_diff_ide) + (grp_att*beta_1_MB_m_diff_att);
  beta_2_shark = beta_2_m_shark + (beta_2_s*beta_2_raw) + (grp_dep*beta_2_m_diff_dep) + (grp_ide*beta_2_m_diff_ide) + (grp_att*beta_2_m_diff_att);
...
model {
  ...
  //define priors for the diff
  alpha_m_diff_dep ~ normal(0,1);
  alpha_m_diff_ide ~ normal(0,1);
  alpha_m_diff_att ~ normal(0,1);

  beta_1_MF_m_diff_dep ~ normal(0,1);
  beta_1_MF_m_diff_ide ~ normal(0,1);
  beta_1_MF_m_diff_att ~ normal(0,1);

  beta_1_MB_m_diff_dep ~ normal(0,1);
  beta_1_MB_m_diff_ide ~ normal(0,1);
  beta_1_MB_m_diff_att ~ normal(0,1);

  beta_2_m_diff_dep ~ normal(0,1);
  beta_2_m_diff_ide ~ normal(0,1);
  beta_2_m_diff_att ~ normal(0,1);
