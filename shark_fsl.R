...
if(!is.null(runTheseGroup)){bdf<-bdf[which(bdf$GROUP1245 %in% runTheseGroup),]}
...
argu<-as.environment(list(nprocess=4,onlyrun=c(1,2,3,4),forcereg=F,cfgpath="/Volumes/bek/autopreprocessing_pipeline/Explore/shark.cfg",
